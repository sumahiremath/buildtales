...
When I first stepped into engineering management, the hardest shift wasn't process or tools. It was identity. One week I was pair-programming with teammates, trading PRs and inside jokes. The next, I was running their 1:1s, setting priorities, and representing their work to leadership.

I had been promoted because of my technical impact — but leadership required a completely different skill: confidence. Not the loud, commanding kind. The steady, grounded confidence that makes a team trust you when you're no longer the one writing most of the code.
...
## The Tension: Respect Without "Proving It"
...
<div style="background: #f8f9fa; border-left: 4px solid #007acc; padding: 1rem; margin: 1rem 0;">
  <strong>"Engineering Leadership: From IC to VP" Series Navigation</strong><br>
  <a href="/series/engineering-leadership/">View complete series roadmap</a> | <strong>Part 1 of 13</strong>
</div>
